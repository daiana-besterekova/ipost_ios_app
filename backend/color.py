...
def closest_remove(rgb_val): 
    rgb_val = remove_rgb_prefix(rgb_val)
    rgb_val = ast.literal_eval(rgb_val)
    return closest_color(rgb_val)

color_string = "rgb(255, 255, 255)"
color_string = remove_rgb_prefix(color_string)
tuple_value = ast.literal_eval(color_string)
print(closest_color(tuple_value))